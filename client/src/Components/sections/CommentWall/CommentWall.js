                ...
                <div className="comment-feed__form-wrapper">
                    ...
                    <form className="comment-feed-form">
                        ...
                        <label htmlFor="comment" className='comment-feed__label'>
                            ...
                            {/* </label> */}
                            <textarea type="text" className="comment-feed__input-textarea comment-feed__input--comment"
                                      id="comment" name="comment" placeholder="Add a new comment"/>
                        </label>
                            ...
                            <article className="comment-feed-waterfall__article" key={comment.id}>
                                ...
                                <div className="comment-feed-waterfall__text-info">
                                    <div className="comment-feed-waterfall__meta-info">
                                        <span className="comment-feed-waterfall__author">{comment.name}</span><span
                                        className="comment-feed-waterfall__date">{formatDate(comment.timestamp)}</span>
                                    </div>
